...
export default function HolidayList() {
  return (
    <div className="max-w-2xl mx-auto p-4">
      <h2 className="text-2xl font-semibold mb-6 text-center dark:text-white">Corporate Holiday List</h2>
     <Card>
      <ul className="divide-y divide-border">
        {holidays.map((holiday) => (
          <li key={holiday.name} className="flex items-center justify-between py-3 flex-wrap lg:gap-0 gap-2">
